...
def get_args():
    ...
    parser.add_argument("--test_lang", type=str, default="404",
                        help=("The language to test on. Default is Georgian"
                              " (404)."))
    # TODO --custom-kwlist will always be true. Need to instead add an option
    # to explicitly select the default Babel kwlist.
...
def prepare_langs(train_langs, recog_langs, filt_dtl=False):
    """Prepares training data; creates dict and lang dirs with L.fst and G.fst
       ...
       If filt_dtl is True, then we remove from the lexicon hypotheses
...
if __name__ == "__main__":
    ...
    ##### Creating RTTM #####
    #force_align(args.test_lang, args)
    #generate_rttm(args.test_lang, args)
